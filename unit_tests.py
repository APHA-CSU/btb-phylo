...
class TestBtbPhylo(unittest.TestCase):
    def test_remove_duplicates(self):
        ...
        nptesting.assert_array_equal(btb_phylo.remove_duplicates(test_df, pcMapped="max", Ncount="min").values,
        ...
        nptesting.assert_array_equal(btb_phylo.remove_duplicates(test_df, pcMapped="max", Ncount="min", foo="max").values,
