...
def main():
    ...
    parser = argparse.ArgumentParser(description="filter samples")
    parser.add_argument("filtered_filepath", help="path to output filtered sample metadata .csv file")
    ...
    filtered_filepath = clargs.pop("filtered_filepath")
